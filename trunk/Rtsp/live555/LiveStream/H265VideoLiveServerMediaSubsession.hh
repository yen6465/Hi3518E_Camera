...
public:
	static H265VideoLiveServerMediaSubsession*
		createNew(UsageEnvironment& env, H265VideoLiveMediaSource& wisInput, Boolean reuseFirstSource);
...
protected:
	H265VideoLiveServerMediaSubsession(UsageEnvironment& env,
		H265VideoLiveMediaSource& wisInput, Boolean reuseFirstSource);
...
private:
	...
	H265VideoLiveMediaSource& fWISInput;
};
